...
public class Http {
    ...
    public static final String PAISES_URL_JSON = "https://restcountries.eu/rest/v1/all";
    ...
    public static List<Paises> carregarPaisesJson() {
        try {
            HttpURLConnection conexao = connectar(PAISES_URL_JSON);
    ...
    private static List<Paises> lerJsonPaises(JSONArray json) throws JSONException {
        ...
        for (int j = 0; j < json.length(); j++) {
            ...
            Paises paises = new Paises(
                    ...
                    unidade.getString("demonym"),
                    unidade.getString("area"),
                    unidade.getString("gini"),
                    unidade.getString("nativename"),
                 unidade.getString("numericCode")
